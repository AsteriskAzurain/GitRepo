...
<td>
	<div class="top">
		...
		<td ><a align="right" class="msg"><s:property value="msg"/></a>
			<s:property value="#session.user.username" /></td></tr>
	</table>
	
	<div class="container">
		<ul class="menu">
			<li><a href="backinsert.jsp">添加用户</a></li>
			<li><a href="backupdate.jsp">修改用户</a></li>
			<li><a href="backshowPart.jsp">查询用户</a></li>
			<li><a href="backshowAll.jsp">显示所有用户</a></li>	
